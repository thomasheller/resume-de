...
\homepage{http://thomasheller.me}
% \social[linkedin]{thomas-heller-962305131}
...
\cventry{08/2013--09/2014}{Software-Entwickler (Java/Android, C\texttt{\#})}{SWING GmbH}{Freiburg im Breisgau}{}{\begin{itemize}
\item Entwicklung von SWING2Go in Java (Android-basierte Tabletlösung in der Pflegeinformatik)
\item Entwicklung von Webschnittstellen und Lösungen zur Datenbank-Synchronisation in Java, C\texttt{\#}, Google Protocol Buffers und JSON
\item Entwicklung von SWING Controlling (Software zum Finanzcontrolling für Ambulante Pflegedienste) in C\texttt{\#} (ASP.NET und PC)
...
\item Webentwicklung von SWING2Go (Software zur mobilen Datenerfassung auf iPad) in C\texttt{\#} (ASP.NET)
\item Entwicklung interner Analysetools zum Finanzcontrolling in C\texttt{\#} (PC)
